      ...
      <section className="flex flex-col items-center gap-2 mx-auto py-8 md:py-12 lg:py-24 md:pb-8 lg:pb-20 max-w-[980px]">
        ...
        <div className="flex justify-center items-center space-x-4 py-4 md:pb-10 w-full">
          ...
          <a
            target="_blank"
            rel="noreferrer"
            className="inline-flex justify-center items-center border-input bg-background hover:bg-accent disabled:opacity-50 shadow-sm px-4 py-2 border rounded-md font-medium text-sm whitespace-nowrap transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring h-9 hover:text-accent-foreground disabled:pointer-events-none"
            href="https://github.com/MarloneA/Fullstack-Nextjs"
          >
